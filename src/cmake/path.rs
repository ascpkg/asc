...
pub fn cmake_lists_path(options: &util::cli::CommandLines) -> String {
...
pub fn config_cmake_in_path(options: &util::cli::CommandLines) -> String {
    format!(
        "{}/{}-config.cmake.in",
...
pub fn config_h_cm_path(options: &util::cli::CommandLines) -> String {
    format!("{}/config.h.cm", &options.project_dir)
}

pub fn check_cmake_path(options: &util::cli::CommandLines) -> String {
